                        ...
                        <div class="col-sm-12">
                            ...
                            $tanggapan=$Pelaporan->getTanggapanbyid($report['id_Pelaporan']);
                                    ...
                                    foreach ($tanggapan as $key ) {
                                    	...
                                    	if ($key['idtanggap']==$_GET['id']) {?>
                                    		<div class="col-sm-offset-1 ">
                                        <div class="panel panel-default">
                                <div class="panel-body">
                                <form method="post" action="updaterespond.php">
                                	<textarea class="form-control" rows="5" name="isi" required><?php echo "$key[isi]"; ?></textarea>
                                	<input type="hidden" name="idtanggap" value="<?php echo "$_GET[id]"; ?>">
                                	<input type="hidden" name="idlaporan" value="<?php echo "$_GET[idlapor]"; ?>">
                                	<hr/>
                                	<div class="pull-right">

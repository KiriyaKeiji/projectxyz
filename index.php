...
<html lang="en">
    ...
    <head>
        ...
        <title>Login | AMIKOM Complaints System</title>
                    ...
                    <div class="row">
                        <div class="col-sm-8 col-sm-offset-2 text">
                            ...
                            <div class="description">
                            	<p>
	                            	Login to <strong>AMIKOM Complaints System</strong>
                            	</p>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-sm-6 col-sm-offset-3 form-box">
                        	<div class="form-top">
                        		<div class="form-top-left">
                        			<h3>Login here</h3>
                            		<p>Enter your NIM and password to log in:</p>
                        		</div>
                            ...
                            <div class="form-bottom">
			                    <form role="form" action="index.php" method="post" class="login-form">
			                    	<div class="form-group">
			                        	...
			                        	<input type="text" name="usr" placeholder="Username or NIM..." class="form-username form-control" id="form-username">
			                        </div>
			                        <div class="form-group">
			                        	<label class="sr-only" for="form-password">Password</label>
			                        	<input type="password" name="pwd" placeholder="Password..." class="form-password form-control" id="form-password">
			                        </div>
			                        <button type="submit" class="btn" href="index.php" >Sign in!</button>
			                    </form>
		                    </div>
